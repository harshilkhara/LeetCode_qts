# Approach 1- Group words by their initial
def distinctNames(ideas): # TC O(n*m) // SC O(n*m)
    ...
    for i in range(25):
        for j in range(i + 1, 26):
            ...
            # Since we can swap a with b and swap b with a to 
            # create two valid names, multiple answer by 2.
